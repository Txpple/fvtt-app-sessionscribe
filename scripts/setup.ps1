...
# Moved from fvtt-mcp-dnd5e's session-scribe skill (2026-09-23); the smoke test is now
# worker\transcribe.py, the scribe's only Python.
...
& $py "$PSScriptRoot\..\worker\transcribe.py" smoke $clip
...
Write-Host ''
Write-Host 'session-scribe toolchain READY. (scribe-status reports it too.)'
